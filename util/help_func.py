...
def draw_random_card(diff: int) -> dict[str, Any]:
    ...
    match diff:
        case 1: randomized = random.choices([1, 2], weights=[80, 20], k=1)[0]
        case 2: randomized = random.choices([1, 2, 3], weights=[20, 70, 10], k=1)[0]
        case 3: randomized = random.choices([1, 2, 3, 4], weights=[15, 30, 45, 10], k=1)[0]
        case 4: randomized = random.choices([2, 3, 4, 5], weights=[5, 30, 55, 10], k=1)[0]
        case 5: randomized = random.choices([3, 4, 5], weights=[10, 60, 30], k=1)[0]
    allowed_draw = {}
